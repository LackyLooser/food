...
function calc(){
    ...
    if(localStorage.getItem('ratio')){
     ...
     calculation()
     function getStaticData(selector, classActive){
...
function cards(){
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getDataMenu)('http://localhost:3000/menu')
    .then(data =>{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getDataMenu": () => (/* binding */ getDataMenu),
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('2022-08-11');
